...
{
    printf("+");
    for(int i=0;i<length;i++)//Use the for statement to print
    {printf("-");}
    printf("+\n");
}
...
{
    printf("|");
    for(int i=0;i<x;i++)//Use the for statement to print
    {printf(".");}
    printf("@");
    for (int i=0;i<length-x-1;i++)//Use the for statement to print
    {printf(".");}
    printf("|\n");
}
...
int main(void)//Define the main function and output the corresponding image according to the preset value
{
    drawRoom(2, 2, 0, 1);
    drawRoom(5, 3, 1, 2);
    drawRoom(14, 8, 8, 5);
